...
public class EmployeeRegisterView extends RegisterPage<EmployeeRegisterRequest> implements
    ValidationUtils {
    ...
    @Override
    public Map<String, Object> fetchData(EmployeeRegisterRequest user, Map<String, Object> payload) {
