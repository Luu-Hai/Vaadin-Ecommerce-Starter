package com.lcaohoanq.views.admin.gridwithfilters;

import com.lcaohoanq.data.SamplePerson;
import com.lcaohoanq.services.SamplePersonService;
...
public class GridwithFiltersView extends Div {
    ...
    private Component createGrid() {
        ...
        grid.addColumn("role").setAutoWidth(true);
        grid.addColumn("created_at").setAutoWidth(true);
        grid.addColumn("updated_at").setAutoWidth(true);
        grid.addColumn("avatar_url").setAutoWidth(true);
        grid.addColumn("subscription").setAutoWidth(true);
        */
